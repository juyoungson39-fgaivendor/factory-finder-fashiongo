...
serve(async (req) => {
  ...
  const payload: Record<string, unknown> = {
    ...
    supplier_index: (parsed as any).supplier_index ?? null,
    response_rate: (parsed as any).response_rate ?? null,
    year_established: (parsed as any).year_established ?? null,
    ...
    p1_self_shipping_score: aiAutoScores.international_trust.score,
    p1_image_quality_score: scoreP1(enriched).image_quality,
    p1_moq_score: aiAutoScores.moq_flexibility.score,
    p1_lead_time_score: aiAutoScores.lead_time_reliability.score,
    p1_communication_score: aiAutoScores.communication.score,
    p1_variety_score: aiAutoScores.variety.score,
