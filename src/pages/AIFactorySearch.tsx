...
const VENDOR_PRODUCTS: Record<string, { name: string; nameKor: string; yuan: number; img: string }[]> = {
  basic: [
    {
      name: "Smocked Halter Maxi Dress",
      nameKor: "스모크 홀터 맥시 드레스",
      yuan: 126,
      img: "https://images.unsplash.com/photo-1515886657613-9f3515b0c78f?w=200&h=240&fit=crop",
    },
    {
      name: "Reversible Ribbed Tank Top",
      nameKor: "리버서블 리브드 탱크탑",
      yuan: 84,
      img: "https://images.unsplash.com/photo-1495385794356-15371f348c31?w=200&h=240&fit=crop",
    },
    {
      name: "Mineral Wash Relaxed Cotton Tee",
      nameKor: "미네랄워시 릴렉스핏 티셔츠",
      yuan: 77,
      img: "https://images.unsplash.com/photo-1434389677669-e08b4cac3105?w=200&h=240&fit=crop",
    },
    {
      name: "Classic Satin Camisole",
      nameKor: "클래식 새틴 캐미솔",
      yuan: 91,
      img: "https://images.unsplash.com/photo-1469334031218-e382a71b716b?w=200&h=240&fit=crop",
    },
    {
      name: "Gingham Ruffle Blouse",
      nameKor: "깅엄 러플 블라우스",
      yuan: 105,
      img: "https://images.unsplash.com/photo-1485462537746-965f33f7f6a7?w=200&h=240&fit=crop",
    },
    {
      name: "Round Neck Extended Sweater Top",
      nameKor: "라운드넥 오버사이즈 스웨터탑",
      yuan: 126,
      img: "https://images.unsplash.com/photo-1509631179647-0177331693ae?w=200&h=240&fit=crop",
    },
  ],
  curve: [
    {
      name: "Plus Size Floral Tiered Midi Dress",
      nameKor: "플러스 플로럴 티어드 미디 드레스",
      yuan: 154,
      img: "https://images.unsplash.com/photo-1515886657613-9f3515b0c78f?w=200&h=240&fit=crop",
    },
    {
      name: "Plus Size Wide Leg Linen Pants",
      nameKor: "플러스 와이드 레그 린넨 팬츠",
      yuan: 140,
      img: "https://images.unsplash.com/photo-1434389677669-e08b4cac3105?w=200&h=240&fit=crop",
    },
    {
      name: "Plus Size Smocked Maxi Dress",
      nameKor: "플러스 스모크 맥시 드레스",
      yuan: 168,
      img: "https://images.unsplash.com/photo-1469334031218-e382a71b716b?w=200&h=240&fit=crop",
    },
    {
      name: "Curve Ribbed Tank Top",
      nameKor: "커브 리브드 탱크탑",
      yuan: 84,
      img: "https://images.unsplash.com/photo-1495385794356-15371f348c31?w=200&h=240&fit=crop",
    },
    {
      name: "Plus Size Jogger Drawstring Pants",
      nameKor: "플러스 조거 드로스트링 팬츠",
      yuan: 119,
      img: "https://images.unsplash.com/photo-1509631179647-0177331693ae?w=200&h=240&fit=crop",
    },
    {
      name: "Curve Square Neck Bodycon Dress",
      nameKor: "커브 스퀘어넥 바디콘 드레스",
      yuan: 133,
      img: "https://images.unsplash.com/photo-1485462537746-965f33f7f6a7?w=200&h=240&fit=crop",
    },
  ],
  denim: [
    {
      name: "Easy Flow Wide Leg Denim Pants",
      nameKor: "와이드 레그 데님 팬츠",
      yuan: 154,
      img: "https://images.unsplash.com/photo-1509631179647-0177331693ae?w=200&h=240&fit=crop",
    },
    {
      name: "90s Vintage High Rise Flare Jeans",
      nameKor: "90년대 빈티지 하이라이즈 플레어 진",
      yuan: 168,
      img: "https://images.unsplash.com/photo-1434389677669-e08b4cac3105?w=200&h=240&fit=crop",
    },
    {
      name: "Raw Hem Crop Slim Wide Leg Jeans",
      nameKor: "로우헴 크롭 슬림 와이드 진",
      yuan: 154,
      img: "https://images.unsplash.com/photo-1485462537746-965f33f7f6a7?w=200&h=240&fit=crop",
    },
    {
      name: "Denim Camo Contrast Jacket",
      nameKor: "데님 카모 콘트라스트 자켓",
      yuan: 182,
      img: "https://images.unsplash.com/photo-1469334031218-e382a71b716b?w=200&h=240&fit=crop",
    },
    {
      name: "Lace Edge Wide Leg Denim Overall",
      nameKor: "레이스 엣지 와이드 데님 오버롤",
      yuan: 196,
      img: "https://images.unsplash.com/photo-1495385794356-15371f348c31?w=200&h=240&fit=crop",
    },
    {
      name: "Barrel Leg Distressed Jeans",
      nameKor: "배럴 레그 디스트레스드 진",
      yuan: 161,
      img: "https://images.unsplash.com/photo-1515886657613-9f3515b0c78f?w=200&h=240&fit=crop",
    },
  ],
  vacation: [
    {
      name: "Sunny Days Bikini Set",
      nameKor: "써니 데이즈 비키니 세트",
      yuan: 98,
      img: "https://images.unsplash.com/photo-1434389677669-e08b4cac3105?w=200&h=240&fit=crop",
    },
    {
      name: "Coco Kalo Pareo Cover-Up",
      nameKor: "코코 칼로 파레오 커버업",
      yuan: 112,
      img: "https://images.unsplash.com/photo-1469334031218-e382a71b716b?w=200&h=240&fit=crop",
    },
    {
      name: "Linen Trousers 100% Linen",
      nameKor: "100% 린넨 트라우저",
      yuan: 154,
      img: "https://images.unsplash.com/photo-1485462537746-965f33f7f6a7?w=200&h=240&fit=crop",
    },
    {
      name: "Coastal Stripe Smocked Jumpsuit",
      nameKor: "코스탈 스트라이프 점프수트",
      yuan: 168,
      img: "https://images.unsplash.com/photo-1509631179647-0177331693ae?w=200&h=240&fit=crop",
    },
    {
      name: "Women's Solid Color Button-Up Shirt",
      nameKor: "솔리드 컬러 버튼업 셔츠",
      yuan: 98,
      img: "https://images.unsplash.com/photo-1495385794356-15371f348c31?w=200&h=240&fit=crop",
    },
    {
      name: "Crochet Front Button Down Shorts Set",
      nameKor: "크로셰 버튼 다운 반바지 세트",
      yuan: 196,
      img: "https://images.unsplash.com/photo-1515886657613-9f3515b0c78f?w=200&h=240&fit=crop",
    },
  ],
  festival: [
    {
      name: "Back Lace Up Mermaid Evening Dress",
      nameKor: "백 레이스업 머메이드 이브닝 드레스",
      yuan: 224,
      img: "https://images.unsplash.com/photo-1469334031218-e382a71b716b?w=200&h=240&fit=crop",
    },
    {
      name: "Sequin Formal Gown",
      nameKor: "시퀸 포멀 가운",
      yuan: 280,
      img: "https://images.unsplash.com/photo-1515886657613-9f3515b0c78f?w=200&h=240&fit=crop",
    },
    {
      name: "Floral Tiered Ribbon Strap Maxi Dress",
      nameKor: "플로럴 티어드 리본 맥시 드레스",
      yuan: 196,
      img: "https://images.unsplash.com/photo-1485462537746-965f33f7f6a7?w=200&h=240&fit=crop",
    },
    {
      name: "Eyelet Lace Tube Dress",
      nameKor: "아일렛 레이스 튜브 드레스",
      yuan: 168,
      img: "https://images.unsplash.com/photo-1434389677669-e08b4cac3105?w=200&h=240&fit=crop",
    },
    {
      name: "Mixed-Media T-Shirt Dress with Sheer Lace Skirt",
      nameKor: "믹스미디어 티셔츠 시어 레이스 드레스",
      yuan: 182,
      img: "https://images.unsplash.com/photo-1495385794356-15371f348c31?w=200&h=240&fit=crop",
    },
    {
      name: "Applique Zip Up Hooded Jacket",
      nameKor: "아플리케 집업 후드 자켓",
      yuan: 154,
      img: "https://images.unsplash.com/photo-1509631179647-0177331693ae?w=200&h=240&fit=crop",
    },
  ],
  trend: [
    {
      name: "Expensive & Difficult Puff Sweatshirt",
      nameKor: "익스펜시브 그래픽 스웨트셔츠",
      yuan: 119,
      img: "https://images.unsplash.com/photo-1509631179647-0177331693ae?w=200&h=240&fit=crop",
    },
    {
      name: "Easy Tiger Retro Ringer Shirt",
      nameKor: "이지 타이거 레트로 링거 셔츠",
      yuan: 112,
      img: "https://images.unsplash.com/photo-1495385794356-15371f348c31?w=200&h=240&fit=crop",
    },
    {
      name: "Salty Graphic Sweatshirt",
      nameKor: "살티 그래픽 스웨트셔츠",
      yuan: 140,
      img: "https://images.unsplash.com/photo-1434389677669-e08b4cac3105?w=200&h=240&fit=crop",
    },
    {
      name: "Activewear Crop Top & Shorts Set",
      nameKor: "액티브웨어 크롭탑 세트",
      yuan: 154,
      img: "https://images.unsplash.com/photo-1469334031218-e382a71b716b?w=200&h=240&fit=crop",
    },
    {
      name: "Mesh Lace High Neck Fitted Top",
      nameKor: "메쉬 레이스 하이넥 피티드 탑",
      yuan: 98,
      img: "https://images.unsplash.com/photo-1485462537746-965f33f7f6a7?w=200&h=240&fit=crop",
    },
    {
      name: "Kindness Is Golden Graphic Tee",
      nameKor: "킨드니스 이즈 골든 그래픽 티",
      yuan: 91,
      img: "https://images.unsplash.com/photo-1515886657613-9f3515b0c78f?w=200&h=240&fit=crop",
    },
  ],
...
const VENDOR_FACTORIES: Record<string, { name: string; city: string }[]> = {
  basic: [
    { name: "Ruili Fashion", city: "Guangzhou" },
    { name: "Mingyi Style", city: "Hangzhou" },
    { name: "HK Baodeyou", city: "Shenzhen" },
  ],
  curve: [
    { name: "Ruili Fashion", city: "Guangzhou" },
    { name: "Leqier Fashion", city: "Hangzhou" },
  ],
  denim: [
    { name: "Leqier Fashion", city: "Hangzhou" },
    { name: "Ruili Fashion", city: "Guangzhou" },
...
const AIFactorySearch = () => {
  ...
  const dismissMatch = (factoryId: string) => {
    setTrendMatches((prev) => prev.filter((m) => m.factory_id !== factoryId));
  };
    ...
    <div>
                  ...
                  {imageAnalysis && (
                    <div className="space-y-2 border rounded-lg p-3 bg-secondary/30">
                      ...
                      <div className="grid grid-cols-2 gap-x-4 gap-y-1 text-xs">
                        <div>
                          <span className="text-muted-foreground">제품:</span> {imageAnalysis.product_type}
                        </div>
                        <div>
                          <span className="text-muted-foreground">소재:</span> {imageAnalysis.material}
                        </div>
                        <div>
                          <span className="text-muted-foreground">색상:</span> {imageAnalysis.color}
                        </div>
                        <div>
                          <span className="text-muted-foreground">카테고리:</span> {imageAnalysis.category}
                        </div>
                      </div>
          ...
          {searchMatches.length > 0 && (
            <div className="space-y-6">
              <h2 className="text-lg font-semibold">
                매칭 결과 ({searchMatches.length}개 상품, {Object.keys(matchesByVendor).length}개 벤더)
              </h2>
              {Object.entries(matchesByVendor)
                .sort(
                  ([, a], [, b]) => Math.max(...b.map((m) => m.match_score)) - Math.max(...a.map((m) => m.match_score)),
                )
                        ...
                        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3">
                          {vendorMatches
                            ...
                            .map((match) => {
                              ...
                              return (
                                <div
                                  key={`${vendorId}-${match.product_index}`}
      ...
      {activeTab === "trends" && (
        <div className="space-y-6">
            ...
            <CardContent className="space-y-3">
              <div>
                ...
                <p className="text-[11px] text-muted-foreground mt-1.5">
                  스타일, 카테고리, 타겟 연령, 가격대, 시즌, 소재 등 구체적으로 입력할수록 정확한 트렌드 분석이
                  가능합니다
                </p>
              </div>
                        ...
                        <CardContent className="pt-4 pb-3 px-4">
                          <div className="flex items-start justify-between mb-2">
                            ...
                            <Badge variant="outline" className={`text-[10px] ${demandColor(style.estimated_demand)}`}>
                              {style.estimated_demand === "high"
                                ? "높음"
                                : style.estimated_demand === "medium"
                                  ? "보통"
                                  : "낮음"}
                            </Badge>
                          </div>
                          ...
                          <div className="flex flex-wrap gap-1">
                            {style.keywords.slice(0, 4).map((kw, j) => (
                              <span key={j} className="text-[10px] px-1.5 py-0.5 bg-secondary rounded">
                                {kw}
                              </span>
                            ))}
                          </div>
          ...
          <div>
            ...
            <Card>
              {STATIC_TOP_VENDORS.map((v, idx) => (
                <div
                  key={v.name}
                  className={`flex items-center gap-4 px-5 py-3 ${idx < STATIC_TOP_VENDORS.length - 1 ? "border-b border-border" : ""}`}
                >
                  ...
                  <Badge
                    variant="outline"
                    className="text-[10px] bg-score-excellent/10 text-score-excellent border-score-excellent/20"
                  >
                    Top Vendor
                  </Badge>
                </div>
                ...
                <Card>
                  {topFactories.map((f, idx) => (
                    <Link key={f.id} to={`/factories/${f.id}`}>
                      <div
                        className={`flex items-center gap-4 px-5 py-3 hover:bg-secondary/50 transition-colors ${idx < topFactories.length - 1 ? "border-b border-border" : ""}`}
                      >
          ...
          {trendMatches.length > 0 && (
            <div>
              <h3 className="text-xs uppercase tracking-widest text-muted-foreground font-medium mb-3">
                🏭 매칭된 공장 ({trendMatches.length})
              </h3>
              <Card>
                {trendMatches.map((match, idx) => (
                  <div
                    key={match.factory_id}
                    className={`p-4 ${idx < trendMatches.length - 1 ? "border-b border-border" : ""}`}
                  >
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex gap-1 flex-shrink-0">
                        ...
                        <Button size="sm" className="h-8 gap-1 text-xs" onClick={() => setApproveModalMatch(match)}>
          ...
          {!trendData && (
            <div>
              ...
              <Card>
                  ...
                  >
                    <div className="flex-1">
                      <p className="text-sm">
                        ...
                        {(a.trend_keywords as string[])?.length > 5 &&
                          ` 외 ${(a.trend_keywords as string[]).length - 5}개`}
                      </p>
                    ...
                    <Button
                      ...
                      onClick={() => {
                        if (a.source_data) setTrendData(a.source_data as unknown as TrendData);
                      }}
                      title="결과 보기"
                    >
                ...
                {analyses.length === 0 &&
                  STATIC_RECENT_ANALYSES.map((sa, idx) => (
                    <div
                      key={sa.id}
        ...
        <div className="space-y-6">
          <Card>
            <CardHeader className="pb-3">
              ...
              <CardDescription className="text-xs">
                이 스코어 이상이고 APPROVED 상태인 공장만 자동 등록됩니다
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="flex items-center gap-3">
          ...
          {qualifiedFactories.length === 0 ? (
            ...
            <Card>
              {qualifiedFactories.map((f, idx) => (
                <Link key={f.id} to={`/factories/${f.id}`}>
                  <div
                    className={`flex items-center gap-4 px-5 py-3 hover:bg-secondary/50 transition-colors ${idx < qualifiedFactories.length - 1 ? "border-b border-border" : ""}`}
                  >
                    <ScoreBadge score={f.overall_score ?? 0} size="sm" />
                    <div className="flex-1">
                      <p className="text-sm font-medium">{f.name}</p>
                    ...
                    <Badge
                      variant="outline"
                      className="text-[10px] uppercase tracking-wider bg-success/10 text-success border-success/20"
                    >
              ...
              {queue.map((item, idx) => (
                <div key={item.id} className={`px-5 py-3 ${idx < queue.length - 1 ? "border-b border-border" : ""}`}>
                  ...
                  >
                    <div className="flex-1">
                      ...
                      {item.product_data && (item.product_data as any).matched_keywords && (
                        <div className="flex flex-wrap gap-1 mt-1">
                          {((item.product_data as any).matched_keywords as string[])
                            .slice(0, 3)
                    ...
                    <Badge
                      variant={
                        item.status === "listed" ? "default" : item.status === "failed" ? "destructive" : "secondary"
                      }
      ...
      {activeTab === "schedule" && (
        <SchedulePanel
          ...
          onSave={(cron: string, active: boolean, cats: string[]) =>
            saveSchedule.mutate({ cronExpression: cron, isActive: active, categories: cats })
          }
        ...
        <div className="flex items-center gap-3 p-3 rounded-lg bg-secondary/30">
          ...
          <div className="flex-1">
            <div className="flex items-center gap-2">
              ...
              <Badge
                variant={item.status === "listed" ? "default" : item.status === "failed" ? "destructive" : "secondary"}
                className="text-[10px] uppercase tracking-wider"
              >
                {item.status === "listed" ? "등록완료" : item.status === "failed" ? "실패" : "대기중"}
              </Badge>
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              <Label className="text-sm font-medium">
                상품 목록{" "}
                {products.length > 0 && (
                  <span className="text-muted-foreground font-normal">({products.length}개)</span>
                )}
              </Label>
    ...
    <div className="space-y-6">
      ...
      <Card className="border-border">
        <CardContent className="flex items-center gap-4 py-4">
          <div
            className={`w-8 h-8 rounded-full flex items-center justify-center ${isActive ? "bg-success/10" : "bg-secondary"}`}
          >
          ...
          <div>
            ...
            <p className="text-xs text-muted-foreground">
              {isActive
                ? `${currentPreset?.label || selectedCron} 주기로 자동 실행됩니다`
                : "수동으로만 트렌드를 분석합니다"}
            </p>
          </div>
        </CardContent>
