...
import EditSourceableProductDialog from './EditSourceableProductDialog';
            ...
            {pagedItems.map((p) => {
              ...
              return (
                ...
                >
                  ...
                  {/* ② 이미지 — storage > mirror > original */}
                  <td className="px-3 py-2 align-top" style={{ width: 70 }}>
                    <ImageCell
                      src={p.image_url_storage ?? p.image_url_mirror ?? p.image_url}
                      alt={p.product_no}
                    />
                  </td>
                  ...
                  <td className="px-3 py-2 min-w-[140px] align-top">
                    <span style={{ fontSize: 13, fontWeight: 600, fontFamily: 'monospace', color: 'hsl(var(--foreground))' }}>{p.product_no || '—'}</span>
                  </td>

                  {/* ⑧ 카테고리 */}
                  <td className="px-3 py-2 align-top">
                    <span style={{ fontSize: 12, background: 'hsl(var(--muted))', padding: '2px 8px', borderRadius: 4, color: 'hsl(var(--foreground))' }}>{p.category || '—'}</span>
                  </td>
                  ...
                  <td className="px-3 py-2 max-w-[150px] align-top">
                    <span style={{ fontSize: 12, color: 'hsl(var(--muted-foreground))' }}>{p.material || '—'}</span>
                  </td>

                  {/* ⑫ 색상/사이즈 */}
                  <td className="px-3 py-2 max-w-[200px] align-top">
                    <span style={{ fontSize: 12, color: 'hsl(var(--muted-foreground))' }}>{p.color_size || '—'}</span>
                  </td>
                  ...
                  <td className="px-2 py-2 whitespace-nowrap align-top">
                    <div className="flex gap-1.5">
                      ...
                      <Button variant="outline" size="sm" className="h-7 w-[80px] text-xs" onClick={() => openEditDialog(p)}>수정하기</Button>
                    </div>
                  </td>
                </tr>
              );
